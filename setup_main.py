...
main_files = ["App.py", "Monitor.py", "Simulator.py", "GenerateDataset.py", "TrainingModel.py", "Simulator.py"]
...
ignore_files = ['build', 'package', 'venv', '__pycache__', '.git', 'setup.py', 'setup_main.py', 'App.py', "Monitor.py",
                '__init__.py', "Simulator.py", "GenerateDataset.py", "TrainingModel.py", "Simulator.py"]
